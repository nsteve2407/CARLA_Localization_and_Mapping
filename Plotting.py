...
ax.set_xlabel("Position mtr.")
ax.set_ylabel("Position mtr.")
est_traj_fig = plt.figure()
ax = est_traj_fig.add_subplot(111)
ax.plot(gt.x_e,gt.x_gt, label='Estimated vs Ground Truth x')
ax.set_xlabel("Position mtr.")
ax.set_ylabel("Position mtr.")
#ax.plot(gt.x_gt,gt.y_gt, label='Ground Truth')
est_traj_fig = plt.figure()
ax = est_traj_fig.add_subplot(111)
ax.plot(gt.y_e,gt.y_gt, label='Estimated vs Ground Truth y')
ax.set_xlabel("Position mtr.")
ax.set_ylabel("Position mtr.")
